...
public class AudioEffectPanel extends FrameLayout {
    ...
    private List<ItemEntity> createAudioChangeItems() {
        ...
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_punk), R.drawable.audio_effect_setting_changetype_foreign, AUDIO_VOICECHANGER_TYPE_6));
    ...
    private List<BGMItemEntity> createBGMItems() {
        ...
        list.add(new BGMItemEntity("Test1", ONLINE_BGM_FIRST, ""));
        list.add(new BGMItemEntity("Test2", ONLINE_BGM_SECOND, ""));
        list.add(new BGMItemEntity("Test3", ONLINE_BGM_THIRD, ""));
        return list;
    }
