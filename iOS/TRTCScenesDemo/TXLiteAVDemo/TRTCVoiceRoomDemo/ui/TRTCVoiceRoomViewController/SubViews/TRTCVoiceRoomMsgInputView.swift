...
class TRTCVoiceRoomMsgInputView: UIView {
    ...
    let msgTextFiled: UITextField = {
        ...
        textField.attributedPlaceholder = NSAttributedString.init(string: "Share something", attributes: [.font: UIFont.systemFont(ofSize: 16.0), .foregroundColor: UIColor.placeholderBackColor])
