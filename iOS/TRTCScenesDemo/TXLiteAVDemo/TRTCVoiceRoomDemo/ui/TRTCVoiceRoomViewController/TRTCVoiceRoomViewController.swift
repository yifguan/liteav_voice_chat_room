...
public class TRTCVoiceRoomViewController: UIViewController {
    ...
    // MARK: - Methods:
    init(viewModelFactory: TRTCVoiceRoomViewModelFactory, roomInfo: VoiceRoomInfo, role: VoiceRoomViewType, toneQuality: VoiceRoomToneQuality = .defaultQuality) {
...
private extension String {
    static let controllerTitle = "Room number"
}
